...
function T(expected: BigSource, value: BigSource) {
  assertEquals(new Big(String(value)).abs().toString(), String(expected));
}
...
test({
  ...
  fn(): void {
    ...
    assertEquals(!isMinusZero(new Big(minusZero).abs()), true);
